...
public Vector getAllCities() throws Exception {
    Connection con = null;
    PreparedStatement pt = null;
    ResultSet rs = null;
    try {
        con = util.DBConnectionManager.getConnectionFromPool();
        Vector vec = new Vector();
        pt = con.prepareStatement("SELECT id, name, is_active FROM ticket_city ORDER BY name");
        rs = pt.executeQuery();
        while (rs.next()) {
            Vector row = new Vector();
            row.addElement(rs.getInt("id"));
...
public boolean addCity(String name) throws Exception {
    ...
    try {
        con = util.DBConnectionManager.getConnectionFromPool();
        con.setAutoCommit(false);
        pt = con.prepareStatement("INSERT INTO ticket_city (name, is_active) VALUES (?, 1)");
        pt.setString(1, name);
        int result = pt.executeUpdate();
        con.commit();
        return result > 0;
...
public boolean updateCity(int id, String name) throws Exception {
    Connection con = null;
    PreparedStatement pt = null;
    try {
        con = util.DBConnectionManager.getConnectionFromPool();
        con.setAutoCommit(false);
        pt = con.prepareStatement("UPDATE ticket_city SET name = ? WHERE id = ?");
        pt.setString(1, name);
        pt.setInt(2, id);
        int result = pt.executeUpdate();
        con.commit();
...
public boolean toggleCity(int id, int status) throws Exception {
    Connection con = null;
    PreparedStatement pt = null;
    try {
        con = util.DBConnectionManager.getConnectionFromPool();
        con.setAutoCommit(false);
        pt = con.prepareStatement("UPDATE ticket_city SET is_active = ? WHERE id = ?");
        pt.setInt(1, status);
        pt.setInt(2, id);
        int result = pt.executeUpdate();
        con.commit();
...
public Vector getAllAgents() throws Exception {
    Connection con = null;
    PreparedStatement pt = null;
    ResultSet rs = null;
    try {
        con = util.DBConnectionManager.getConnectionFromPool();
        Vector vec = new Vector();
        pt = con.prepareStatement("SELECT id, name, is_active FROM ticket_agent ORDER BY name");
        rs = pt.executeQuery();
        while (rs.next()) {
            Vector row = new Vector();
            row.addElement(rs.getInt("id"));
...
public boolean addAgent(String name) throws Exception {
    Connection con = null;
    PreparedStatement pt = null;
    try {
        con = util.DBConnectionManager.getConnectionFromPool();
        con.setAutoCommit(false);
        pt = con.prepareStatement("INSERT INTO ticket_agent (name, is_active) VALUES (?, 1)");
        pt.setString(1, name);
        int result = pt.executeUpdate();
        con.commit();
        return result > 0;
...
public boolean updateAgent(int id, String name) throws Exception {
    Connection con = null;
    PreparedStatement pt = null;
    try {
        con = util.DBConnectionManager.getConnectionFromPool();
        con.setAutoCommit(false);
        pt = con.prepareStatement("UPDATE ticket_agent SET name = ? WHERE id = ?");
        pt.setString(1, name);
        pt.setInt(2, id);
        int result = pt.executeUpdate();
        con.commit();
...
public boolean toggleAgent(int id, int status) throws Exception {
    Connection con = null;
    PreparedStatement pt = null;
    try {
        con = util.DBConnectionManager.getConnectionFromPool();
        con.setAutoCommit(false);
        pt = con.prepareStatement("UPDATE ticket_agent SET is_active = ? WHERE id = ?");
        pt.setInt(1, status);
        pt.setInt(2, id);
        int result = pt.executeUpdate();
        con.commit();
